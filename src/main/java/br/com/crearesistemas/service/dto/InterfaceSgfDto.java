...
public class InterfaceSgfDto {
	...
	InterfaceSgf interfaceTipo = InterfaceSgf.NENHUM;
	...
	public void setInterfaceTipo(InterfaceSgf interf) {
		this.interfaceTipo = interf;
		
	}
	public InterfaceSgf getInterfaceTipo() {
		return interfaceTipo;
	}
	public Long getOtId() {
		return otId;
	}
