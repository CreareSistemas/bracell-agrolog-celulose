...
@WebService(serviceName = "PCSIL1/WSRecebeTemposMediosCicloInterno", targetNamespace = "http://crearesistemas.com.br/")
	...
	implements WSRecebeTemposMediosCicloInterno 
{
	...
	) 
	{
		...
		try {
			...
			responseNamedQuery	= caminhoesService.selecionaPorFluxoSiteIndustrialL1(de, ate);
