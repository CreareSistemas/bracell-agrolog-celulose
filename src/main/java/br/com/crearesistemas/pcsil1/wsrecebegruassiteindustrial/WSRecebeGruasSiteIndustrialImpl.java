...
@WebService(serviceName = "PCSIL1/WSRecebeGruasSiteIndustrial", targetNamespace = "http://crearesistemas.com.br/")
public class WSRecebeGruasSiteIndustrialImpl extends WSBase implements WSRecebeGruasSiteIndustrial {
	...
	public RecebeGruasSiteIndustrialResponse recebeGruasSiteIndustrial(
		...
		try {
			response.setGruasEntity(config, service.selecionarGruasSiteIndustrialL1(config.getCustomerId()), service);
		}
