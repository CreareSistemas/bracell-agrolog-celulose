...
public class TempoMedioCicloInterno {
	...
	public Integer getTotalFabrica() {
		return totalFabrica;
	}
	public void setTotalFabrica(Integer totalFabrica) {
			...
			EntidadeProprietaria entidade)
	{
		...
		_ret.setTotal(total);
		_ret.setTotalFabrica(totalFabrica);
